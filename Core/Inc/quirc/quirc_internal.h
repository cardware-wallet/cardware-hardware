...
#define QUIRC_MAX_REGIONS	24 //254
#endif
#define QUIRC_MAX_CAPSTONES	3 //32
//#define QUIRC_MAX_GRIDS		(QUIRC_MAX_CAPSTONES * 2)
#define QUIRC_MAX_GRIDS		1 //8
...
#define QUIRC_FLOAT_TYPE
#define QUIRC_USE_TGMATH
...
#define QUIRC_MAX_VERSION     4 //3 -2
#define QUIRC_MAX_ALIGNMENT   2 //7
